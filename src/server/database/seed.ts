    ...
    data: [
      {
        ...
        branchIdsJson: JSON.stringify(["house-of-hair", "look-hair-extensions"]),
        active: true,
      ...
      },
      {
        ...
        primaryBranchId: "house-of-hair",
        branchIdsJson: JSON.stringify(["house-of-hair"]),
        active: true,
        commissionMode: "SYSTEM_RULES",
        avatarColor: "#9f7a5a",
      },
      {
        ...
        branchIdsJson: JSON.stringify(["look-hair-extensions"]),
        active: true,
        commissionMode: "SYSTEM_RULES",
        avatarColor: "#546b5f",
      },
